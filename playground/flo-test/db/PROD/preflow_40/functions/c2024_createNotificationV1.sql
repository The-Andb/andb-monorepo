CREATE FUNCTION `c2024_createNotificationV1`(pnUserId             BIGINT(20)
...
--         --
  ...
  INSERT INTO collection_notification
    ...
    `action`, action_time, assignees, content, kanban_id, created_date, updated_date, channel_id)
  VALUES
    (pnUserId, pvUsername, nCollectionId, CASE WHEN pnAction IN (6, 61, 62, 24) THEN pnCommentId ELSE 0 END, pvObjectUid, pvObjectType
    ,pnAction, pnActionTime, CASE WHEN pnAction IN (17, 18) THEN ifnull(pvAssignee, '') ELSE '' END, ifnull(vContent, ''), pnKanbanID, pnUpdatedDate, pnUpdatedDate, pnChannelId);
  --
