CREATE FUNCTION `c2024_createNotification`(pnUserId             BIGINT(20)
...
--         --
  ...
  INSERT INTO collection_notification
    ...
    `action`, action_time, assignees, content, kanban_id, created_date, updated_date)
  VALUES
    (pnUserId, pvUsername, pnCollectionId, CASE WHEN pnAction IN (6, 61, 62, 24) THEN pnCommentId ELSE 0 END, pvObjectUid, pvObjectType
    ,pnAction, pnActionTime, CASE WHEN pnAction IN (17, 18) THEN ifnull(pvAssignee, '') ELSE '' END, ifnull(vContent, ''), pnKanbanID, pnUpdatedDate, pnUpdatedDate);
  --
