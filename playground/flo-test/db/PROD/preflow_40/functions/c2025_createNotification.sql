CREATE FUNCTION `c2025_createNotification`(pnUserId             BIGINT(20)
...
BEGIN
  ...
  VALUES
    ...
    ,pnAction, pnActionTime, CASE WHEN pnAction IN (17, 18) THEN ifnull(pvAssignee, '') ELSE '' END, ifnull(vContent, ''), pnKanbanID, pnUpdatedDate, pnUpdatedDate, pnCategory);
  --
