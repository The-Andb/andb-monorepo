...
BEGIN
  ...
  IF nColType = 3 THEN
    ...
    IF nIsOwner = 1 THEN
      ...
      INSERT INTO kanban (user_id, collection_id, `name`, color, order_number, archive_status, order_kbitem, order_update_time, show_done_todo, add_new_obj_type, sort_by_type, archived_time, kanban_type, is_trashed, created_date, updated_date, kanban_status) 
      VALUES
        -- Members
     ...
     ELSE
       ...
       INSERT INTO kanban 
         (user_id, collection_id,`name`,color, order_number, archive_status, order_kbitem, order_update_time, show_done_todo, add_new_obj_type, sort_by_type, archived_time, kanban_type, is_trashed, created_date, updated_date, kanban_status) 
       VALUES
         -- Notifications
  ...
  --
  IF nIsOwner = 1 THEN
    -- Agile, Status for ToDo's, Recently Added, Email, Event, ToDo's, Contacts, Calls, Notes, Websites, Files
    INSERT INTO kanban 
      (user_id, collection_id, `name`, color, order_number, archive_status, order_kbitem, order_update_time, show_done_todo, add_new_obj_type, sort_by_type, archived_time, kanban_type, is_trashed, created_date, updated_date, kanban_status) 
    VALUES
      -- Agile
