CREATE PROCEDURE `c2023_createCollectionHistoryV3`(pnCollectionId       BIGINT(20)
...
sp_createHistory:BEGIN
  ...
  ELSE
    ...
    INSERT INTO collection_history
      (collection_activity_id, email, action, action_time, assignees, content, kanban_id, kanban_card_id, created_date, updated_date)
    VALUES
      (nCAID, vEmail, pnAction, pnActionTime
      ,CASE WHEN pnAction IN (17, 18) THEN ifnull(pvAssignee, '') ELSE '' END
      ,pnKanbanID, pnKanbanCardID, pvContent, pnCreatedDate, pnUpdatedDate)
    ...
    SELECT ca.collection_id, ca.object_uid, ca.object_type, ca.object_href
          ...
          ,ch.assignees
          ,ch.kanban_id, ch.kanban_card_id
