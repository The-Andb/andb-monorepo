CREATE PROCEDURE `c2025_createChannelV2`(
pnUserId         BIGINT(20)
...
BEGIN
  ...
  -- CHECK existed creator
    ...
    VALUES
      ...
      pvDescription, pvAvatar, ifnull(pnVip, 0), nEnableChatHistory, '',pnNotificationChat,pnNotificationCall, pnCreatedDate, pnCreatedDate, pnUpdatedDate);
