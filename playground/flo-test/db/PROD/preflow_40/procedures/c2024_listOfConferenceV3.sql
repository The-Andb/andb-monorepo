CREATE PROCEDURE `c2024_listOfConferenceV3`(pvKeyword       TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
...
-- LEFT JOIN collection co ON (co.id = cc.collection_id)
    WHERE cm.user_id = pnUserId
      ...
      AND IF(pvCollectionIds IS NOT NULL, FIND_IN_SET(lco.collection_id, pvCollectionIds), 1)
