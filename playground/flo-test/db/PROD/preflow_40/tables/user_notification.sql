CREATE TABLE `user_notification` (
  ...
  KEY `comp_idx_user_notifications` (`collection_notification_id`,`user_id`,`deleted_date`,`updated_date`),
  KEY `idx_is_active` (`is_active`),
  KEY `index_for_case_not_exist_modifiled` (`user_id`,`is_active`,`created_date`) USING BTREE,
  KEY `user_notification_user_id_IDX` (`user_id`,`updated_date`,`is_active`) USING BTREE
