CREATE FUNCTION `o2024_getObjectTitle`(pvObjectUid           VARBINARY(1000)
                                                              ,pvObjectType          VARBINARY(50)) RETURNS VARCHAR(1000) CHARSET utf8mb3 COLLATE utf8mb3_unicode_ci
BEGIN
  --
