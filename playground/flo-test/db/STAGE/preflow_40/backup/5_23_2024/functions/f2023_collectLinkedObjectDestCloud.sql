CREATE FUNCTION `f2023_collectLinkedObjectDestCloud`(pvLinkType    VARCHAR(45)
...
LEFT JOIN cloud clo ON (lo.destination_object_uid = clo.uid AND lo.user_id = clo.user_id)
