CREATE FUNCTION `f2023_collectContactHistoryDestCloud`(pvLinkType    VARCHAR(45)
...
LEFT JOIN cloud clo ON (ch.destination_object_uid = clo.uid AND ch.user_id = clo.user_id)
