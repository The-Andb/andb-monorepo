...
main_block: BEGIN
    ...
    DECLARE user_cursor CURSOR FOR
        ...
        LEFT JOIN preflow_40.user_deleted ud ON aat.user_id = ud.user_id
        WHERE ud.id IS NULL
    ...
    user_loop: LOOP
        ...
        -- ====================================================================
        -- OLD SUBSCRIPTION SYSTEM (preflow_40) - Only report_cached_user
        ...
        UPDATE preflow_40.report_cached_user rcu
        SET rcu.subs_type = 2, 
            rcu.sub_id = psSubId, 
        ...
        INSERT INTO preflow_40.api_last_modified (user_id, api_name, api_modified_date, created_date, updated_date)
