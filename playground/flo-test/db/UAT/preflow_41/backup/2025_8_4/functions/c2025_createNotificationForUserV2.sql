CREATE FUNCTION `c2025_createNotificationForUserV2`(pnUserId             BIGINT(20)
...
BEGIN
 ...
 LEFT JOIN cal_todo ct ON ca.object_type = 'VTODO' AND ca.object_uid = ct.uid 
  ...
  VALUES
    ...
    ,pnAction, pnActionTime, '', ifnull(pvContent, ''), 0, pnUpdatedDate, pnUpdatedDate, pnChannelId, pvEmojiUnicode, pnAccountId, nCategory, pnIsReply);
  --
