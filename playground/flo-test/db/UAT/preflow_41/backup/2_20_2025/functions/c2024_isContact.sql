CREATE FUNCTION `c2024_isContact`(pvUsername       VARCHAR(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci -- owner addressbook
                                                    ,pvEmailContact   VARCHAR(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci -- contact email
