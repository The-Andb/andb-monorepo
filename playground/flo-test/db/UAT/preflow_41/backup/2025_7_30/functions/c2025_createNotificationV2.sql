...
BEGIN
  ...
  IF vContent = '' THEN
    --
   SET vContent = o2024_getObjectTitle(pvObjectType, pvObjectUid); 
    --
  END IF;
  -- GET category
  ...
  VALUES
    (pnUserId, pvUsername, pnCollectionId, CASE WHEN pnAction IN (6, 61, 62, 63) THEN pnCommentId ELSE 0 END, pvObjectUid, pvObjectType
  ...
  SET nReturn = n2024_afterCreateNotification4SharedCollection(nNotiID,
     pnCollectionId, 0, pvObjectType, pnAction, pvUsername, pvAssignee, pnActionTime, pnUpdatedDate, pnUpdatedDate);
