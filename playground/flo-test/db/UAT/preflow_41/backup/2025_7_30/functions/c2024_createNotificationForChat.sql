...
--   END IF;
  ...
  -- CREATE notification for ALL member
  SET nReturn = n2025_afterCreateNotification4Conference(nNotiID, nCollectionId, pnChannelId, pvObjectType, pnAction, pnActionTime, pnUpdatedDate, pnUpdatedDate, pnUserId);
    -- increase unread badges
    SET nReturn = n2024_increaseNotificationBadge(
      nNotiID,
      nCollectionId,
