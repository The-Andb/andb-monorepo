CREATE DEFINER=`tritv`@`172.29.7.109` PROCEDURE `c2023_createConferenceHistorySendInviteV2`(pnChannelId    BIGINT(20)
                                                                            ,pnUserId          BIGINT(20)
                                                                            ,pnType            TINYINT(1)
...
BEGIN
  ...
  SELECT vMemberSend sendTo, vMemberSend ignoreTo;
