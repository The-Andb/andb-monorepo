CREATE PROCEDURE `c2024_listOfConferenceV4`(pvKeyword       TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
                                                            ,pvEmails          TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
                                                            ,pnFilterType      TINYINT(1)
                                                            ,pnCollectionId    BIGINT(20) -- find link only
...
-- LEFT JOIN collection co ON (co.id = cc.collection_id)
    WHERE cm.user_id = pnUserId
      ...
      AND (pvCollectionIds IS NULL OR FIND_IN_SET(cc.collection_id, pvCollectionIds))
