...
sp_removeComment: BEGIN
  ...
  SELECT cc.id, ca.collection_id, ca.object_uid, ca.object_type, ca.object_href
        ,ca.id, cc.email, cc.action_time, cc.comment, cc.parent_id       
    INTO nCommentID, nCollectionId, vObjectUid, vObjectType, vObjectHref
        ,nCAID, vEmail, nActionTime, vComment, nParentId
  ...
  SELECT nCommentID id, nCollectionId collection_id
        ,vObjectUid object_uid, vObjectType object_type, vObjectHref object_href
        ,nCAID collection_activity_id, vEmail email, nActionTime action_time, vComment `comment`, nParentId parrent_id;
  --
END