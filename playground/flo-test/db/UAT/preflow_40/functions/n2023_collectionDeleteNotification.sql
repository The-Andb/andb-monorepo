CREATE FUNCTION `n2023_collectionDeleteNotification`(
pnID            BIGINT(20)
,pnUserId       BIGINT(20)
...
BEGIN
  ...
  SET nID = n2023_createUserNotification(pnID, 0, 0, NULL, pnDeletedDate, pnDeletedDate, pnDeletedDate, pnUserID);
  -- already deleted
  IF nID < 1 THEN
    --
    RETURN nID;
