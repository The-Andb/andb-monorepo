CREATE TABLE `storage_file_edit_session` (
  ...
  `edit_token` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `version` int NOT NULL DEFAULT '1',
  `temp_file_path` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `file_uid` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
