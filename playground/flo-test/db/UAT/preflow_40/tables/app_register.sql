CREATE TABLE `app_register` (
  ...
  `app_reg_id` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `app_alias` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `email_register` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
