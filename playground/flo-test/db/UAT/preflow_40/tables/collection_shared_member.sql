CREATE TABLE `collection_shared_member` (
  ...
  `access` tinyint NOT NULL COMMENT 'This is permission shared collection. value = -1 >> sharing public collection - read only, value = 1 >> owner, value = 2 >> read, value = 3 >> read-write',
  `shared_status` tinyint unsigned NOT NULL DEFAULT '0' COMMENT 'The status of the shared collection, value = 0 >> waiting, value = 1 >> joined, value = 2 >> declined, value = 3 >> removed by owner, value = 4 >> leave shared collection',
