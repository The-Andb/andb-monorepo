CREATE TABLE `tracking_app` (
  ...
  `flo_version` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `app_id` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `build_number` varchar(45) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
