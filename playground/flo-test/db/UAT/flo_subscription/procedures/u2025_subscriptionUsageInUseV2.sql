CREATE PROCEDURE `u2025_subscriptionUsageInUseV2`(
    IN pnUserID BIGINT
)
BEGIN
  --
  ...
  SELECT o.id order_id, o.plan_id, o.user_id
    ...
    ,u.used_value,u.used_data
    -- Byte fields (existing)
    ,u.todo_bytes
    ,u.event_bytes
    ,u.note_bytes
    ,u.card_bytes
    ,u.file_comment_bytes
    ,u.file_chat_bytes
    ,u.file_note_bytes
    ,u.mail_bytes
    ,u.cal_bytes
    -- Object count fields (new IN V2)
    ,u.todo_count
    ,u.event_count
    ,u.note_count
    ,u.card_count
    ,u.file_note_count
    ,u.file_chat_count
    ,u.file_comment_count
    ,u.email_count
    ,u.created_date usage_created_date, u.updated_date usage_updated_date
    ...
    ,a_reach.limit_at reach_limit_at, a_exceed.limit_at exceed_limit_at
    ,CASE
   ...
   LEFT JOIN LATERAL (
       SELECT limit_at FROM alert
       WHERE user_id = o.user_id
         AND component_id = c.id
         AND limit_type = 'REACH'
