CREATE TABLE `pending_events` (
  ...
  `request_uid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `transaction_uid` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `idx_user_status` (`user_token`,`status`),
