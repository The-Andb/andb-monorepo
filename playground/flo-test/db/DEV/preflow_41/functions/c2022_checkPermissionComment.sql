CREATE FUNCTION `c2022_checkPermissionComment`(nCommentId           BIGINT(20)
...
BEGIN
 ...
 /* IF ifnull(ncollectionId, 0) = 0 THEN
  ...
  SET nReturn = c2022_checkPermissionActivity(nCollectionId, ifnull(objectUid, vObjectUid), objectType, nUserId);
  --
