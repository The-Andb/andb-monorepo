CREATE FUNCTION `c2024_checkPermissionHistory`(nHistotyId           BIGINT(20)
...
BEGIN
  ...
  /*IF ifnull(ncollectionId, 0) = 0 THEN
    ...
    -- 
  END IF;*/
  SET nReturn = c2024_checkPermissionActivity(nCollectionId, pnKanbanId, objectUid, objectType, nUserId);
  --
  RETURN nReturn;
  --
END