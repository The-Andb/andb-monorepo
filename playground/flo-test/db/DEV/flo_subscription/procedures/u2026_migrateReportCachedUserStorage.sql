CREATE PROCEDURE `u2026_migrateReportCachedUserStorage`(
...
BEGIN
    ...
    WHILE pnCurrentMinId <= pnMaxUserId DO
        ...
        -- storage field: JSON WITH breakdown (mail_bytes, cal_bytes, etc.) + NEW COUNT FIELDS
        ...
        IF psUserEmail IS NULL THEN
            ...
            SET 
                rcu.storage = JSON_OBJECT(
                    ...
                    'note_count', COALESCE(u.note_count, 0),
                    'todo_count', COALESCE(u.todo_count, 0),
                    'event_count', COALESCE(u.event_count, 0),
                    'card_count', COALESCE(u.card_count, 0),
                    'file_note_count', COALESCE(u.file_note_count, 0),
                    'file_comment_count', COALESCE(u.file_comment_count, 0),
                    'file_chat_count', COALESCE(u.file_chat_count, 0)
                ),
