...
Tài liệu này định nghĩa chiến lược đóng gói và phát hành (hoàn toàn tách bạch) cho hệ sinh thái TheAndb, đảm bảo Desktop App không bị trói buộc vòng đời phiên bản với Core Package trên NPM.
...
- **Giải pháp Nâng cao**:
  ...
  - Lúc Desktop tải về, nó sẽ _tự động fetch_ file binary `andb-cli` bản mới nhất (khớp checksum) về mục `Application Support`.
