...
console.log('\n--- DDL Exports (last 5) ---');
const exports = db.prepare('SELECT environment, database_name, export_type, export_name, database_type, file_path FROM ddl_exports ORDER BY exported_at DESC LIMIT 5').all();
console.log(exports);
